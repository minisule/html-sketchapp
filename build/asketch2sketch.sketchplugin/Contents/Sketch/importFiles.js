...
var _normalizeCssColor = __webpack_require__(17);
...
exports.fixImageFill = fixImageFill;
exports['default'] = fixImageFillsInLayer;

var _fixSVG = __webpack_require__(6);
...
exports['default'] = importFiles;

var _asketch2sketch = __webpack_require__(8);
...
function importFiles(context) {
  ...
  var urls = Array.from(panel.URLs());

  var asketchFiles = urls.map(function (url) {
  ...
  (0, _asketch2sketch2['default'])(context, asketchFiles);
}
...
var _fixFont = __webpack_require__(16);

var _fixImageFill = __webpack_require__(5);

var _fixImageFill2 = _interopRequireDefault(_fixImageFill);

var _fixBitmap = __webpack_require__(24);

var _fixBitmap2 = _interopRequireDefault(_fixBitmap);

var _fixSVG = __webpack_require__(6);

var _fixSVG2 = _interopRequireDefault(_fixSVG);

var _zoomToFit = __webpack_require__(25);
...
function getNativeLayer(failingLayers, layer) {
  ...
  try {
    nativeObj = (0, _sketchappJsonPlugin.fromSJSONDictionary)(layer);
  } catch (e) {
...
function addSharedTextStyle(document, style) {
  ...
  if (container.addSharedStyleWithName_firstInstance) {
    container.addSharedStyleWithName_firstInstance(style.name, (0, _sketchappJsonPlugin.fromSJSONDictionary)(style.value));
  } else {
    var sharedStyle = void 0;
    var allocator = MSSharedStyle.alloc();

    if (allocator.initWithName_firstInstance) {
      sharedStyle = allocator.initWithName_firstInstance(style.name, (0, _sketchappJsonPlugin.fromSJSONDictionary)(style.value));
    } else {
      sharedStyle = allocator.initWithName_style(style.name, (0, _sketchappJsonPlugin.fromSJSONDictionary)(style.value));
    }
...
function asketch2sketch(context, asketchFiles) {
  ...
  if (asketchPage) {
    ...
    if (failingLayers.length === 1) {
      _ui2['default'].alert('asketch2sketch', 'One layer couldn\'t be imported and was skipped.');
    } else if (failingLayers.length > 1) {
      _ui2['default'].alert('asketch2sketch', String(failingLayers.length) + ' layers couldn\'t be imported and were skipped.');
    } else {
      var emojis = ['👌', '👍', '✨', '😍', '🍾', '🤩', '🎉', '👏', '💪', '🤘', '💅', '🏆', '🚀'];

      _ui2['default'].message('Import successful ' + String(emojis[Math.floor(emojis.length * Math.random())]));
    }
...
var _findFont = __webpack_require__(19);

var _findFont2 = _interopRequireDefault(_findFont);

var _getSketchVersion = __webpack_require__(23);
...
function createStringAttributes(textStyles) {
  ...
  if ((0, _getSketchVersion2['default'])() >= 50) {
...
var _hashStyle = __webpack_require__(20);
...
var findFont = function findFont(style) {
  ...
  var fontWeight = style.fontWeight ? FONT_WEIGHTS[style.fontWeight] : defaultFontWeight;
...
var _murmur2js = __webpack_require__(21);

var _murmur2js2 = _interopRequireDefault(_murmur2js);

var _sortObjectKeys = __webpack_require__(22);
...
function hashStyle(obj) {
  return obj ? (0, _murmur2js2['default'])(JSON.stringify((0, _sortObjectKeys2['default'])(obj))) : 0;
}
...
exports['default'] = fixBitmapLayer;

var _fixImageFill = __webpack_require__(5);

function fixBitmapLayer(layer) {
  (0, _fixImageFill.fixImageFill)(layer, layer);
}
