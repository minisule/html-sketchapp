...
var SymbolMaster = function (_Base) {
  ...
  function SymbolMaster(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (SymbolMaster.__proto__ || Object.getPrototypeOf(SymbolMaster)).call(this, { id: id }));
  ...
  _createClass(SymbolMaster, [{
    ...
    value: function () {
      function getSymbolInstance(_ref2) {
        ...
        return new _symbolInstance2['default']({
          x: x,
          y: y,
          width: width,
          height: height,
